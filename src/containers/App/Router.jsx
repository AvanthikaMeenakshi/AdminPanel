...
import Users from '../LimeProxyComponents/Users/index';
...
const Commerce = () => (
  <Switch>
    ...
    <Route path="/dashboard_default/edit/:index" component={ECommerceDashboardEdit} />
  </Switch>
);

const UsersRoutes = () => (
  <Switch>
    <Route exact path="/users/active" component={Users} />
    <Route exact path="/users/signedup" component={Users} />
    <Route exact path="/users/all" component={Users} />
    <Route exact path="/users/deactivated" component={Users} />
  </Switch>
);
...
const wrappedRoutes = () => (
  <div>
    ...
    <div className="container__wrap">
      ...
      <Route path="/panel_protection" component={FitnessDashboard} />
